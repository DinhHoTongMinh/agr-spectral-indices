...
The ready-to-use curated list of spectral indices ([check the list here](https://github.com/DinhHoTongMinh/agr-spectral-indices/blob/master/Output/)) for remote sensing applications is presented here. The list is available in the csv formats ([CSV](https://github.com/DinhHoTongMinh/agr-spectral-indices/blob/master/Output/Spectral%20Vegetation%20Indices.csv)).
